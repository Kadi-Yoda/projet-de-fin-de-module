...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-10 col-lg-offset-1">
                <form id="contact-form" method="POST" action="traitement/ajout.php">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <button type="submit" id="but" class="btn btn-success button-form"> ajouter</span></button>
                        <button type="submit" id="but" class="btn btn-danger button-form"> ajouter</span></button>
                    </div>
